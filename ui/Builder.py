...
class mainUI(QMainWindow):
    ...
    def globalWidgets(self):
        ...
        self.showGuidePropertiesButton.setToolTip("Opens the guide component settings")
        ...
        self.selectComponentButton.setToolTip("Selects the component group of the selected object")
        ...
        self.guideSelectPivotButton.setToolTip("Selects the guide pivots from the current selection")
        ...
        self.guideSelectShapeButton.setToolTip("Selects the guide shapes from the current selection")
